...
class MetaContactForm(forms.Form):
    # name = forms.CharField(label='',  widget=forms.TextInput(attrs={'readonly':'readonly', 'class': 'form-control'}))
    ...
    # api_id = forms.CharField(label='Api ID',  widget=forms.TextInput(attrs={'readonly':'readonly'}))
    # api_hash = forms.CharField(label='Api Hash',  widget=forms.TextInput(attrs={'readonly':'readonly'}))
    # phone_number = forms.CharField(label='Phone Number',  widget=forms.TextInput(attrs={'readonly':'readonly'}))
